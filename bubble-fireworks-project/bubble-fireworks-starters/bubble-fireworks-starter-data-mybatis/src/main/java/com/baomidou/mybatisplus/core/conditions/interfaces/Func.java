...
public interface Func<Children, R> extends Serializable {
     ...
     *
     * @author fxbin
     * @since 2020/11/18 14:07
     * @param column    字段
     * @param coll      数据集合
     * @return Children
     */
    default Children inIfPresent(R column, Collection<?> coll) {
     ...
     *
     * @author fxbin
     * @since 2020/11/18 14:06
     * @param column    字段
     * @param coll      数据集合
     * @return Children
     */
    default Children notInIfPresent(R column, Collection<?> coll) {
        if (CollectionUtils.isNotEmpty(coll)) {
            return notIn(true, column, coll);
        }
        return (Children) this;
     ...
     * @return Children
     */
    default Children notInIfPresent(R column, Object... values) {
