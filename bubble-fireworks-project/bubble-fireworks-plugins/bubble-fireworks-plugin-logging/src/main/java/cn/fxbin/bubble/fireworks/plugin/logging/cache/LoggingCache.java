...
public interface LoggingCache {
     ...
     * @param fireworksLogging cn.fxbin.bubble.fireworks.plugin.logging.model.BubbleFireworksLogging
     */
     ...
     * @param count 日志数量
     * @return java.util.List<cn.fxbin.bubble.fireworks.plugin.logging.model.BubbleFireworksLogging>
     */
