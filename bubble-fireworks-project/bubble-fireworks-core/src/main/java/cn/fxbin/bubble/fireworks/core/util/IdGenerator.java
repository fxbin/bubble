...
/**
 * IdGenerator 基于Twitter的Snowflake算法实现分布式高效有序ID
...
public class IdGenerator {
    ...
    public IdGenerator(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public IdGenerator(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
