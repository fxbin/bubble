package cn.fxbin.bubble.fireworks.autoconfigure.plugin.threadpool.endpoint;

import cn.fxbin.bubble.fireworks.autoconfigure.plugin.threadpool.DynamicThreadPoolProperties;
import cn.fxbin.bubble.fireworks.core.util.MathUtils;
import cn.fxbin.bubble.fireworks.plugin.dynamic.threadpool.endpoint.model.ThreadPoolInfo;
