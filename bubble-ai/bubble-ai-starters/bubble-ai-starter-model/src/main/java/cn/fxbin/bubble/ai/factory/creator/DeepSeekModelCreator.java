...
/**
 * DeepSeek 模型创建器
 * <p>负责创建DeepSeek平台的ChatModel和EmbeddingModel实例</p>
 *
 * @author fxbin
 */
public class DeepSeekModelCreator extends AbstractAiModelCreator {

    public DeepSeekModelCreator(BubbleAiProperties properties, ToolCallingManager toolCallingManager, ObservationRegistry observationRegistry, RetryTemplate retryTemplate) {
    ...
    public ChatModel createChatModel(AiPlatformEnum platform, String apiKey, String baseUrl, String model, Double temperature, Integer topK, Double topP) {
        ...
        String finalBaseUrl = StringUtils.isNotBlank(baseUrl) ? baseUrl : "https://api.deepseek.com";
