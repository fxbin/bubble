...
/**
 * SiliconFlow 模型创建器
 * <p>负责创建SiliconFlow平台的ChatModel和EmbeddingModel实例（兼容OpenAI接口）</p>
 *
 * @author fxbin
 */
public class SiliconFlowModelCreator extends AbstractAiModelCreator {

    public SiliconFlowModelCreator(BubbleAiProperties properties, ToolCallingManager toolCallingManager, ObservationRegistry observationRegistry, RetryTemplate retryTemplate) {
    ...
    public ChatModel createChatModel(AiPlatformEnum platform, String apiKey, String baseUrl, String model, Double temperature, Integer topK, Double topP) {
        ...
        String finalBaseUrl = StringUtils.isNotBlank(baseUrl) ? baseUrl : "https://api.siliconflow.cn";
