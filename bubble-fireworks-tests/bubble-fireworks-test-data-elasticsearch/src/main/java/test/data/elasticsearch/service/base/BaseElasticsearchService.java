...
public class BaseElasticsearchService {
    ...
    protected static IndexRequest buildIndexRequest(String index, String id, Object object) {
        return new IndexRequest(index).id(id).source(BeanUtils.object2Map(object), XContentType.JSON);
    }
    ...
    protected void updateRequest(String index, String id, Object object) {
        try {
            UpdateRequest updateRequest = new UpdateRequest(index, id).doc(BeanUtils.object2Map(object), XContentType.JSON);
